...
// The best understanding I could get about arrow functions affect constructor functions was from w3schools.com talking about using 'this'. using arrow functions, there is no binding of 'this' which is used in creating objects from constructors. 'This' keyword represents the object that defined the arrow function. I think I'm on the right path to understanding this answer fully.
...
// 'This' refers to the 'scope' of Joe being name, age, and hometown.
// 2. What is "this" when joe.scopeArrow() is invoked?
// 'This refers to 'name, age, and hometown' logged in the console.
// 3. Explain why "this" is different when an arrow function is used.

//'This' keyword represents the object that defined the arrow function.
